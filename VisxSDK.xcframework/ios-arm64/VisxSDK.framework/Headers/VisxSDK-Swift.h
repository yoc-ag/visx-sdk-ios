...
SWIFT_PROTOCOL("_TtP7VisxSDK22FetchMediationDelegate_")
@protocol FetchMediationDelegate
- (void)didReceive:(NSArray<Mediation *> * _Nonnull)mediations error:(NSError * _Nullable)error;
- (void)fetchingMediationFailed;
@end

@class VisxAdView;

SWIFT_PROTOCOL("_TtP7VisxSDK21LoadMediationDelegate_")
@protocol LoadMediationDelegate
- (void)loadMediationAd:(Mediation * _Nonnull)mediation adView:(VisxAdView * _Nonnull)adView;
@end
...
SWIFT_CLASS("_TtC7VisxSDK16MediationManager")
@interface MediationManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, VisxAdViewAnimationType, open) {
...
+ (VisxAdSize)VisxGetAdSizeFromStringWithServerParameter:(NSString * _Nonnull)serverParameter SWIFT_WARN_UNUSED_RESULT;
/// Returns visxAdSize from Xandr size
+ (VisxAdSize)VisxGetXandrAdSizeWithCgSize:(CGSize)cgSize SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7VisxSDK18VisxRequestBuilder")
@interface VisxRequestBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7VisxSDK14VisxURLRequest")
@interface VisxURLRequest : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7VisxSDK13VisxUtilities")
@interface VisxUtilities : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
