 ...
 */
@interface OMIDYocAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDYocPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDYocPartner *)partner
                               ...
                               resources:(NSArray<OMIDYocVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
